...
export const EmotionQuiz: React.FC<EmotionQuizProps> = ({ age, onCorrect, onExit }) => {
  ...
  return (
    <div className="h-full bg-yellow-50 flex flex-col p-6">
        ...
        <div className="flex-1 flex flex-col items-center justify-center gap-6">
            <div className="text-[8rem] filter drop-shadow-md animate-bounce">
                {question.emoji}
            </div>
            
            <div className="bg-white p-6 rounded-3xl shadow-sm text-center w-full">
